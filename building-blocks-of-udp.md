...
建立一个高效的 NAT 穿透方案不是一件简单的事情。幸好我们可以借助 RFC 5245 提出的交互式连接建立协议(ICE)来帮助我们完成这一任务。如图 3-7 所示，ICE 是一个用来寻找端与端之间最高效隧道建立方法的协议和一组方法。如果可能的话通过 STUN 协商建立直接连接，如果都失败了则采取 TURN。
