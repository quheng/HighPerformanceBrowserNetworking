...
然而，实际上 STUN 是不足以应对所有的 NAT 结构和网络配置。更重要的是，在一些情况下，UDP 可能会被防火墙或者一些其他网络设备阻塞，这在一些企业中是十分常见的情景。为了解决这个问题，当 STUN 失败的时候，我们可以使用 RFC 5766 指定的 NAT 延迟穿透协议 (TURN) 作为备用方案，它可以运行在 UDP 之上，如果失败的话转向使用 TCP。
