...
一个叫做 TeleGeography 的通讯市场研究和咨询公司估计在 2011 年的时候，我们平均只利用了 20% 的已经部署好的海底光纤。更重要的是，在 2007 到 2911 年之间，超过一半的带宽增加是通过 WDM 的技术升级实现的，相同的线路，两端复用数据的技术更好。当然，我们不能期待这样的提升无限制的进行下去，每一种介质都会达到其收益递减点。尽管如此，只要经济允许，我们没有理由不去增加带宽。即使新技术都失败了，我们还可以部署更多的光纤。